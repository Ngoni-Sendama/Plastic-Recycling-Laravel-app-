...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        foreach ([User::class, Material::class, Buyer::class, MaterialIntake::class, CrushingProduction::class, Dispatch::class, PalletizingReceipt::class, PalletizingProduction::class, PelletSale::class, CashRemittance::class] as $modelClass) {
