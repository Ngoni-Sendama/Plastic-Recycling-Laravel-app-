    ...
    <script>
        (() => {
            ...
            const printHtml = () => [
                ...
                '<tr><td class="meta-label">GRN No.</td><td class="meta-value">' + payload.grnNumber + '</td><td class="meta-label">Date</td><td class="meta-value">' + payload.date + '</td></tr>',
                '<tr><td class="meta-label">Buyer name</td><td class="meta-value">' + payload.buyerName + '</td><td class="meta-label">Buyer contact</td><td class="meta-value">' + payload.buyerContact + '</td></tr>',
                '</table>',
                '<div class="section">',
                '<div class="section-title">Material Details</div>',
                '<table class="detail-grid">',
                '<tr><td class="field-label">Material type (PP / HD / LD - circle one)</td><td class="field-value" colspan="3">' + payload.material + '</td></tr>',
                '<tr><td class="field-label">Gross weight (kg)</td><td class="field-value">' + payload.grossWeight + '</td><td class="field-label">Tare weight (kg)</td><td class="field-value">' + payload.tareWeight + '</td></tr>',
                '<tr><td class="field-label">Net weight delivered (kg)</td><td class="field-value">' + payload.netWeight + '</td><td class="field-label">Agreed unit price ($/kg)</td><td class="field-value">$' + payload.unitPrice + '</td></tr>',
                '<tr><td class="field-label">Total value payable to buyer ($)</td><td class="field-value" colspan="3">$' + payload.totalValue + '</td></tr>',
                '<tr><td class="field-label">Remarks / condition of material</td><td class="field-value" colspan="3">' + payload.remarks + '</td></tr>',
                '</table>',
                '</div>',
                '<div class="note">Note: Net weight and total value are posted to the Material Intake Log in the stock control spreadsheet. Original copy to buyer, duplicate retained by Crushing Office.</div>',
                '<div class="section">',
                '<div class="section-title">Signatures</div>',
                '<table class="signature-grid">',
                '<tr><td><span class="line"></span><div class="signature-label">Resident Stock Controller (received by)</div></td><td><span class="line"></span><div class="signature-label">Buyer / supplier (delivered by)</div></td></tr>',
                '</table>',
                '</div>',
                '</div>',
                '</body>',
